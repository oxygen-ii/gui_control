...
def set_buttonY_state():
    ...
    ser.write(bytes(number_step.get(), 'UTF-8'))
    waitUntil(b'r')
    ser.write(bytes(number_angle.get(), 'UTF-8'))
...
global number_step
number_step = tkinter.StringVar()
Entey_number_step = tkinter.Entry(tkTop, textvariable=number_step).place(x=200, y=50, width=40, height=40)

global number_angle
number_angle = tkinter.StringVar()
Entey_number_angle = tkinter.Entry(tkTop, textvariable=number_angle).place(x=200, y=100, width=40, height=40)
